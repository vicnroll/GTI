...
(function (h) {
  ...
  function J(a, b, c) {
    ...
    h.each(b, function (e) {
      d = a._hungarianMap[e];
      if (d !== k && (c || b[d] === k)) 'o' === d.charAt(0) ? (b[d] || (b[d] = {
  ...
  function la(a, b, c) {
    ...
    c !== k && null !== c && (hb(c), J(m.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), h.extend(b, c), F(b, c, 'sWidth', 'sWidthOrig'), c.iDataSort !== k && (b.aDataSort = [
      c.iDataSort
    ]), F(b, c, 'aDataSort'));
    var g = b.mData,
    j = R(g),
  ...
  function Ia(a) {
    ...
    r;
    e = 0;
    for (f = b.length; e < f; e++) if (l = b[e], r = [
    ], !l.sType && l._sManualType) l.sType = l._sManualType;
     else if (!l.sType) {
      g = 0;
  ...
  function O(a) {
    var b = s(a, 'aoPreDrawCallback', 'preDraw', [
      a
    ]);
  ...
  function ua(a, b, c) {
    s(a, 'aoServerParams', 'serverParams', [
      b
    ]);
    if (b && h.isArray(b)) {
      var d = {
  ...
  function zb(a, b, c, d, e, f) {
    if ('' !== b) {
      for (var g = [
      ], j = a.aiDisplay, d = Ra(b, d, e, f), e = 0; e < j.length; e++) b = a.aoData[j[e]]._aFilterData[c],
      d.test(b) && g.push(j[e]);
      a.aiDisplay = g
    }
  }
  ...
  function wa(a, b) {
    ...
    s(a, null, 'plugin-init', [
      a,
      b
    ]);
    s(a, 'aoInitComplete', 'init', [
      a,
      b
    ])
  }
  ...
  function Xa(a, b, c, d) {
    ...
    c && a.oFeatures.bSortMulti ? (c = h.inArray(b, D(e, '0')), - 1 !== c ? (b = g(e[c], !0), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1)  : (e[c][1] = f[b], e[c]._idx = b))  : (e.push([b,
    f[0],
    0]), e[e.length - 1]._idx = 0))  : e.length && e[0][0] == b ? (b = g(e[0]), e.length = 1, e[0][1] = f[b], e[0]._idx = b)  : (e.length = 0, e.push([b,
    f[0]]), e[0]._idx = 0);
    T(a);
  ...
  function Jb(a, b) {
    ...
    for (var f, g = m.ext.type.order[c.sType + '-pre'], j = 0, i = a.aoData.length; j < i; j++) if (c = a.aoData[j], c._aSortData || (c._aSortData = [
  ...
  function za(a) {
    if (a.oFeatures.bStateSave && !a.bDestroying) {
      ...
      s(a, 'aoStateSaveParams', 'stateSaveParams', [
        a,
        b
      ]);
      a.oSavedState = b;
  ...
  function Lb(a, b, c) {
    ...
    b = function (b) {
      if (b && b.time) {
        ...
        if ( - 1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time < + new Date - 1000 * g) && !(b.columns && f.length !== b.columns.length))) {
  ...
  function K(a, b, c, d) {
    ...
    if (b) E.console && console.log && console.log(c);
     else if (b = m.ext, b = b.sErrMode || b.errMode, a && s(a, null, 'error', [
      a,
      d,
      c
    ]), 'alert' == b) alert(c);
  ...
  var m = function (a) {
    ...
    this.each(function () {
      ...
      if ('table' != this.nodeName.toLowerCase()) K(null, 0, 'Non-table node initialisation (' + this.nodeName + ')', 2);
        ...
        null === g.asStripeClasses && (o.asStripeClasses = [
          u.sStripeOdd,
          u.sStripeEven
        ]);
  ...
  Tb = function (a) {
    for (var b = [
    ], c = 0, d = a.length; c < d; c++) a[c] && b.push(a[c]);
    return b
  },
  sa = function (a) {
    var b;
  ...
  u('rows().ids()', 'row().id()', function (a) {
    for (var b = [
    ], c = this.context, d = 0, e = c.length; d < e; d++) for (var f = 0, g = this[d].length; f <
    g; f++) {
